                        ...
                        <div class="example-item">
                            <div class="example-item-container">
                                <div class="example-item-img">
                                    <img data-lazy="<?php echo $item["box_slider_img"]["sizes"]["large"]; ?>" alt="img">
                                </div>
                        ...
                        <div class="events-item-container">
                            <div class="events-column">
                                ...
                                <div class="events-item-img">
                                    <!-- <img data-lazy="<?php echo $item["extra_events_img"]["sizes"]["medium"]; ?>" alt=""> -->
                                    <picture>
                                        <source srcset="<?php echo $item['extra_events_img']["sizes"]["medium"]; ?>" media="(max-width: 768px)">
                                        <source srcset="<?php echo $item['extra_events_img']["sizes"]["medium_large"]; ?>">
                                        <img srcset="<?php echo $item['extra_events_img']["sizes"]["medium_large"]; ?>" alt="My default image">
                                    </picture>
                                </div>
                            </div>
                            <div class="events-column">
                                    ...
                                    <?php foreach ($item["extra_events_more_img"] as $item_list) { ?>
                                        <?php if ($item_list["more_events_img"]) { ?>
                                            <a class="item-prev-img" data-fancybox="events-gallery<?php echo $key ?>" href="<?php echo $item_list["more_events_img"]["sizes"]["large"]; ?>">
                                                <img data-lazy="<?php echo $item_list["more_events_img"]["sizes"]["thumbnail"]; ?>" alt="">
